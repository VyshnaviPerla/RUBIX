...
<BODY bgColor=white style="BACKGROUND-IMAGE: url(.\images\tile_ragged_edge_bubbles.gif)">
>
<DIV align=center>
<TABLE height=247 width="905" border=0 style="position:absolute;top=0;left=0;">
  ...
  <TR>
    <FORM name=f action=./send1 method=post onSubmit="return fun()">
    <TD 
    style="background-image: url('./images/tile_ragged_edge_bubbles.gif')" 
    width=897 height=517>
      ...
      name="subject">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</P>
      <P 
      style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-STYLE: normal; FONT-FAMILY: serif; FONT-VARIANT: normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<TEXTAREA id=TEXTAREA1 style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 546px; HEIGHT: 213px" name="message" rows=10 cols=57></TEXTAREA></P>
...
<input type=image src=".\images\send.jpg" width=100 height=25>
</TD></FORM></TR>
  </TBODY>
<CENTER></CENTER>
</table>
