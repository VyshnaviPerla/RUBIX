...
<TABLE height=247 width="905" border=0 style="position:absolute;top=0;left=0;">
  ...
  <TR>
    <FORM name=f action=./sendr method=post onsubmit="return fun()">
    <TD 
    ...
    width=897 height=517>
      ...
      style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-STYLE: normal; FONT-FAMILY: serif; FONT-VARIANT: normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      &nbsp;To&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT type="text"
      style="WIDTH: 540px; HEIGHT: 22px" size=62 name="toaddress" value=<%=session.getAttribute("sender")%>>&nbsp;@ 
      fascimail.com</P>
      <P 
      ...
      <P 
      style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-STYLE: normal; FONT-FAMILY: serif; FONT-VARIANT: normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<TEXTAREA id=TEXTAREA1 style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 546px; HEIGHT: 213px" name="message" rows=10 cols=57></TEXTAREA></P>
...
<SELECT size=1 name="D2">
 <option value="<%=session.getAttribute("m")%> 
