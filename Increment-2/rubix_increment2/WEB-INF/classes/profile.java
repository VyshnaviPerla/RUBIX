...
String sql="update register set password='"+pass+"',question='"+quest+"',answer='"+answer1+"',name='"+nam+"',lastname='"+lnam+"',profession='"+prof+"',address='"+ad+"',city='"+ci+"',zip='"+zip+"',country='"+coun+"' where LOGINID='"+ses.getAttribute("user")+"'";
...
+"',question='"+quest+"',answer='"+answer1+"',name='"+nam+"',lastname='"+lnam+"',profession='"+prof+"',address='"+ad+"',city='"+ci+"',zip='"+zip+"',country='"+coun+"' where LOGINID='"+ses.getAttribute("user")+"'";
                     pw.println("update register set password='"+pass+"',question='"+quest+"',answer='"+answer1+"',name='"+nam+"',lastname='"+lnam+"',profession='"+prof+"',address='"+ad+"',city='"+ci+"',zip='"+zip+"',country='"+coun+"'  where LOGINID='"+ses.getAttribute("user")+"'");  
