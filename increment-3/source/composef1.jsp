...
<P 
    ...
    <font color="red">Username not exits!!please try again </font> </P>
      ...
      <P 
      style="FONT-WEIGHT: bold; FONT-SIZE: small; FONT-STYLE: normal; FONT-FAMILY: serif; FONT-VARIANT: normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<TEXTAREA id=TEXTAREA1 style="FONT-WEIGHT: bold; FONT-SIZE: small; WIDTH: 546px; HEIGHT: 213px" name="message" rows=10 cols=57><%=session.getAttribute("message")%></TEXTAREA></P>
