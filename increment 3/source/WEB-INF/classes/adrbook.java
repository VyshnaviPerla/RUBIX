     ...
     try
      ...
      pw =res.getWriter();
       ...
       dd+="/"+(d.getYear()+1900);
        ...
        res.setContentType("text/html");
        pw.println("<html>");
        pw.println("<body bgcolor=\'#fbcc7d\' background=\'./images/tile_ragged_edge_bubbles.gif\' alink=black vlink=black link=black>");
        ...
        pw.println("<input type=hidden name=user value="+ses.getAttribute("user")+">");
         pw.println("<center><table  background='./images/bg3.gif' width=40% height=20%><tr><td><b><font color='darkblue'><h1>"+ses.getAttribute("user")+" 's Addressbook</h1></td></tr>");
        ...
        pw.println("</table><br><br><br><center><input type=image img src='./images/delete.jpg' ></center>");
        pw.println("</center></form>");
        pw.println("<form name=add method=post action=./address>");
        pw.println("<center><input type=image <img src='./images/add.jpg'  name=add value='add to contact'></center>");
